...
const TimelineElement = ({
  ...
  <li className="mb-10 ml-8 rounded-lg bg-white px-4 py-4 shadow-md dark:bg-gray-900">
    <span className="absolute -left-3 flex h-6 w-6 items-center justify-center rounded-full bg-blue-100 ring-4 
