  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        ...
        . I am also familiar with TypeScript and Tailwind CSS, and I'm always eager to
        explore new technologies and expand my skill set. I am currently looking
        for a <span className="font-medium">full-time position</span> as a
        software developer, eager to contribute my expertise to innovative
